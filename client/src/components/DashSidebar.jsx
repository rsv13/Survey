      ...
      <Sidebar.Items>
        <Sidebar.ItemGroup>
          ...
          <Link to="/dashboard?tab=surveys">
            <Sidebar.Item active={tab === "surveys"} icon={FcSurvey} labelColor="dark" as="div">
              Surveys
            </Sidebar.Item>
          </Link>
          ...
          {(currentUser.role === "Admin" || currentUser.role === "Group Admin") && (
            <Link to="/dashboard?tab=groups">
              <Sidebar.Item active={tab === "groups"} icon={HiUsers} as="div">
                Groups
              </Sidebar.Item>
            </Link>
          )}
          ...
          {currentUser.role === "Group Admin" && (
            <Link to="/dashboard?tab=groupsUsers">
              <Sidebar.Item active={tab === "groupsUsers"} icon={HiUsers} as="div">
                Users in Group
              </Sidebar.Item>
            </Link>
          )}
