                  ...
                  {filteredUsersNotInGroups.map(user => (
                    ...
                    >
                      ...
                      <Table.Cell>
                        {isAdmin && (
                          <Button
                            onClick={() => handleAddToGroupClick(user._id)}
                            color='primary'
                            size='sm'
                          >
                            Add to Group
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>
              Are you sure you want to add this user "{filteredUsersNotInGroups.find(user => user._id === selectedUserId)?.surveyUsername}" to the group "{groups.find(group => group._id === selectedGroupId)?.name}"?
            </h3>
